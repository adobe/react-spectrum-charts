...
const config: Config = {
  title: 'React Spectrum Charts S2',
  tagline: 'Spectrum 2 charts for React — alpha package documentation',
  favicon: 'https://www.adobe.com/favicon.ico',

  // Set the production url of your site here
  url: 'https://opensource.adobe.com',
  // Set the /<baseUrl>/ pathname under which your site is served
  baseUrl: '/react-spectrum-charts/s2/docs/',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/adobe/react-spectrum-charts/tree/main/packages/docs-s2/',
        },
        theme: {
