...
describe('Chart', () => {
  ...
  describe('Color stories', () => {
    test('Spectrum colors render correctly (light)', async () => {
      ...
      expect(bars[0].getAttribute('fill')).toEqual('#292929'); // S2 gray-800
      expect(bars[1].getAttribute('fill')).toEqual('#505050'); // S2 gray-700
      expect(bars[2].getAttribute('fill')).toEqual('#717171'); // S2 gray-600
      expect(bars[3].getAttribute('fill')).toEqual('#8F8F8F'); // S2 gray-500
    });
    ...
    test('Spectrum colors render correctly (dark)', async () => {
      ...
      expect(bars[0].getAttribute('fill')).toEqual('#DBDBDB'); // S2 gray-800 dark
      expect(bars[1].getAttribute('fill')).toEqual('#AFAFAF'); // S2 gray-700 dark
      expect(bars[2].getAttribute('fill')).toEqual('#8A8A8A'); // S2 gray-600 dark
      expect(bars[3].getAttribute('fill')).toEqual('#6D6D6D'); // S2 gray-500 dark
    });
    ...
    test('background color gets set', async () => {
      ...
      expect(svg).toHaveStyle('background-color: rgb(233, 233, 233);'); // S2 gray-100
