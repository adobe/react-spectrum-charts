...
/** Callback for axis label clicks: receives the label's value (Date for time axes) and its tick index. */
export type AxisLabelClickCallback = (value: string | number | Date, index: number) => void;
