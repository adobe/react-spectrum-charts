...
export interface ChartOptions {
  /**
   * Whether interactive marks use the animated hover/highlight system (smooth opacity + stroke-width
   * transitions) or the original instant production-rule highlight. Defaults to `true` (animated).
   */
  animations?: boolean;
