...
describe('getDimensionField()', () => {
  test('should return the correct dimension', () => {
    ...
    expect(getDimensionField(DEFAULT_CATEGORICAL_DIMENSION, 'time')).toEqual(DEFAULT_TRANSFORMED_TIME_DIMENSION);
  });
});
...
describe('getChartConfig()', () => {
  test('should merge the provided config with the Spectrum 2 Vega config', () => {
