...
export declare const DEFAULT_BULLET_DIRECTION = "column";
...
export declare const DEFAULT_HIDDEN_SERIES: never[];
...
export declare const DEFAULT_LABEL_POSITION = "top";
export declare const DEFAULT_LINE_TYPES: string[];
export declare const DEFAULT_LINE_WIDTHS: string[];
export declare const DEFAULT_LINEAR_DIMENSION = "x";
export declare const DEFAULT_LOCALE = "en-US";
export declare const DEFAULT_METRIC = "value";
export declare const DEFAULT_SCALE_TYPE = "normal";
export declare const DEFAULT_SCALE_VALUE = 100;
export declare const DEFAULT_SECONDARY_COLOR = "subSeries";
export declare const DEFAULT_SYMBOL_SHAPES: string[];
export declare const DEFAULT_SYMBOL_SIZE = 100;
export declare const DEFAULT_SYMBOL_SIZES: string[];
...
export declare const MAX_THUMBNAIL_SIZE = 42;
export declare const MIN_THUMBNAIL_SIZE = 16;
export declare const THUMBNAIL_OFFSET = 4;
export declare const DEFAULT_LEGEND_SYMBOL_SIZE = 250;
export declare const DEFAULT_LEGEND_SYMBOL_WIDTH = 16;
export declare const DEFAULT_LEGEND_COLUMN_PADDING = 20;
export declare const DEFAULT_LEGEND_LABEL_LIMIT = 184;
export declare const TABLE = "table";
export declare const FILTERED_TABLE = "filteredTable";
export declare const CONTROLLED_HIGHLIGHTED_TABLE = "controlledHighlightedTable";
export declare const GROUP_DATA = "rscGroupData";
export declare const MARK_ID = "rscMarkId";
export declare const GROUP_ID = "rscGroupId";
...
export declare const HOVERED_ITEM = "hoveredItem";
export declare const HOVERED_SERIES = "hoveredSeries";
export declare const CONTROLLED_HIGHLIGHTED_ITEM = "controlledHighlightedItem";
export declare const HIGHLIGHTED_GROUP = "highlightedGroup";
export declare const CONTROLLED_HIGHLIGHTED_SERIES = "controlledHighlightedSeries";
...
export declare const FIRST_RSC_SERIES_ID = "firstRscSeriesId";
export declare const LAST_RSC_SERIES_ID = "lastRscSeriesId";
...
export declare const DEFAULT_VENN_COLOR = "sets";
/** default key in data for the metric in the venn diagram */
export declare const DEFAULT_VENN_METRIC = "size";
/** default key in data for the label inside the venn*/
export declare const DEFAULT_VENN_LABEL = "label";
/**
 * @deprecated
 */
export declare const HIGHLIGHT_CONTRAST_RATIO = 5;
export declare const FADE_FACTOR = 0.2;
export declare const TOOLTIP_DELAY = 350;
...
export declare const DIMENSION_HOVER_AREA = "dimensionHoverArea";
