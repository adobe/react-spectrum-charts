...
const REFERENCE_LINE_CAP_ORIGIN = 5;
...
export const REFERENCE_LINE_RULE_X_START: Record<ReferenceLineSize, number> = {
  ...
  L: Math.round(REFERENCE_LINE_CAP_ORIGIN + REFERENCE_LINE_CAP_RIGHT_TIP.L + REFERENCE_LINE_CAP_RULE_GAP),
};
...
export const REFERENCE_LINE_END_CAP_PATHS: Record<ReferenceLineSize, string> = {
  ...
  L: 'M0.540044 -0.935316C-0.179957 -0.519624 -0.179955 0.519606 0.540045 0.935298L8.100054 5.300082C8.820036 5.715774 9.720036 5.19615 9.720036 4.364766L9.720036 -4.364766C9.720036 -5.19615 8.820036 -5.715774 8.100036 -5.300082L0.540044 -0.935316Z',
};
