...
type BulletPropsWithDefaults = 'name' | 'metric' | 'dimension' | 'target' | 'color' | 'direction'| 'showTarget' | 'showTargetValue' | 'labelPosition' | 'scaleType' | 'maxScaleValue' | 'track' | 'threshold';
