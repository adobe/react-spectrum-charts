 ...
 */
import { HIGHLIGHTED_SERIES, MARK_ID } from '@constants';
	...
	if (highlightedItemSignal) {
		...
		highlightedItemSignal.on.push(
			...[
				...
				{ events: `@${legendName}_legendEntry:mouseout`, update: '""' },
			],
		);
	}
};
