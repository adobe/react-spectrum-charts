...
When the component ships, set the spec's `status` to `"implemented"` and `git mv` the file
into `planning/specs/<chartType>/implemented/<slug>.json` as part of the same PR.
